...
export default function AdminPaymentPage() {
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold mb-8">결제/환불 관리</h1>
        ...
        <table className="w-full">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">실납입액</th>
            ...
            {enrollments.map((enrollment) => (
              <tr key={enrollment.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  {(enrollment.discountedFee || enrollment.fee).toLocaleString()}원
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                  {enrollment.paymentMethod === 'account'
                    ...
                    ? '카드결제'
                    : enrollment.paymentMethod === 'voucher'
                    ? '바우처'
                    : '-'}
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                ...
                <td className="px-6 py-4 whitespace-nowrap">{enrollment.paymentDate || '-'}</td>
              </tr>
            ))}
          </tbody>
        </table>
